...
def upgrade():
    ...
    op.create_table('job',
                    ...
                    sa.Column('fadr_version', sa.String(length=20), nullable=True),
    ...
    op.create_table('config',
                    ...
                    sa.Column('FADR_CHECK_UDF', sa.Boolean(), nullable=True),
                    ...
                    sa.Column('FADRPATH', sa.String(length=255), nullable=True),
