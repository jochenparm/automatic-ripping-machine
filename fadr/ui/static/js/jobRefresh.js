...
function refreshJobsComplete() {
    ...
    // Notes: This breaks when fadr child servers are added
 ...
 * *** This doesn't work as it should when fadr has child links
...
function refreshJobsSuccess(data, serverIndex, serverUrl, serverCount) {
    ...
    $.each(data.results, function (_index, job) {
        ...
        job.ripper = (data.fadr_name ? data.fadr_name : "");
...
/**
 * Function to push all child servers from fadr.yaml config into links on the homepage
 */
