"""
FADR route blueprint for jobs pages
Covers
- jobdetail [GET]
- jobdetailload [POST]
- titlesearch [GET]
...
from fadr.ui import app, constants, db, json_api
from fadr.ui.forms import ChangeParamsForm, TitleSearchForm, TrackFormDynamic
...
def jobdetail_load():
    """
    Process updated track ID fields against a job and load to the FADR database if valid
...
def feed_json():
    ...
    if authenticated:
        ...
        valid_data = {
            ...
            'logpath': cfg.fadr_config['LOGPATH'],
            'fail': 'fail',
            'success': 'success',
            'joblist': 'joblist',
            'mode': mode,
