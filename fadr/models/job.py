...
from fadr.models.config import Config  # noqa: F401
# THESE IMPORTS ARE REQUIRED FOR THE db.Relationships to work
from fadr.models.track import Track  # noqa: F401
from fadr.ripper import music_brainz
...
class Job(db.Model):
    ...
    fadr_version = db.Column(db.String(20))
    ...
    def __init__(self, devpath):
        ...
        self.ejected = False
        self.updated = False
        if cfg.fadr_config['VIDEOTYPE'] != "auto":
            self.video_type = cfg.fadr_config['VIDEOTYPE']
        self.parse_udev()
        self.get_pid()
    ...
    def identify_audio_cd(self):
        ...
        temp_log_full = os.path.join(cfg.fadr_config['LOGPATH'], logfile)
    ...
    def eject(self):
        ...
        if not cfg.fadr_config['AUTO_EJECT']:
