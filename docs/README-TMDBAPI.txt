...
FADRui uses a call to the tmdbapi (The Movie Database API) website to determine the full details of a movie.
...
Open the config file (usually /opt/fadr/fadr.yaml) with your favorite text editor and navigate to the
...
That's it! The API key will be propagated throughout the FADRui appropriate, and any future
